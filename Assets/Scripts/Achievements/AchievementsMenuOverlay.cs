...
public class AchievementsMenuOverlay : MonoBehaviour
{
    ...
    [SerializeField] private GameObject AchievementUI_Prefab;
    ...
    public void Open(Action onClosed = null)
    {
        ...
        if(_uiInstance == null)
        {
            _uiInstance = Instantiate(AchievementUI_Prefab, transform);
        }
        else
        {
            _uiInstance.GetComponent<AchievementUI>().RefreshUI();
